...
from utils.postprocess import load_class_names, extract_boxes_onnx, plot_boxes_cv2
# python pytorch2onnx.py ./weights/yolov4.pth ./data/giraffe.jpg 0 80 256 256
...
def detect(session, image_src):
    ...
    boxes = extract_boxes_onnx(0.1, 0.1, outputs)
...
def transform_to_onnx(weight_file, batch_size, n_classes, IN_IMAGE_H, IN_IMAGE_W):
    ...
    if dynamic:
        ...
        onnx_file_name = "yolov4_0_3_{}_{}_dynamic.onnx".format(IN_IMAGE_H, IN_IMAGE_W)
